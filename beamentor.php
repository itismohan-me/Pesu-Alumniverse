<?php
    ...
    $result = mysqli_query($con, "SELECT MAX(id) AS max_id FROM mentorrequests");
    ...
    $eventname=$organizer=$description=$email=$fromdate=$todate=$msg="";
        ...
        if(isset($_POST["submit"])){
            $sql="INSERT INTO mentorrequests(id, eventname, organizer,email, description, fromdate, todate) values ('$next_id','$eventname','$organizer','$alumniEmail','$description','$fromdate','$todate')";
