<?php
    ...
    $sql="SELECT * FROM alumnilogin";
    $result=mysqli_query($con,$sql);
    $alumni_count=$result->num_rows;
?>
<!DOCTYPE html>
<html lang="en">
<head>
...
<body>
    <div class="admindashboard">
        <a href="alumnisearch.php">
            <div class="dashboard-container">
                <div class="number"><?php echo $alumni_count?></div>
                <div class="name">Alumni Registered</div>
            </div>
        </a>
        <a href="queries.php">
            <div class="dashboard-container">
        ...
        <a href="announcements.php">
            <div class="dashboard-container">
                <div class="number"><?php echo $announcements_count?></div>
